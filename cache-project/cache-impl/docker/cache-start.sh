...
$JAVA_HOME/bin/java $SKYWALKING_OPTS -agentlib:jdwp=transport=dt_socket,server=y,suspend=n,address=8000 -jar /usr/local/skywalking/cache-server/cache-server.jar